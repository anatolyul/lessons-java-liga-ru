...
class LoaderBoxesInTrucksUniformAlgServiceTest {
    ...
    void loadBoxesInTrucks_givenFileBoxes_shouldReturnCorrectTrucks() {
        ...
        LoaderBoxesInTrucksUniformAlgService loadingBoxesInTruckService =
                new LoaderBoxesInTrucksUniformAlgService(truckRepository);
        ...
        assertThat(truckRepository.getTrucks()).hasSize(2);
    }
}